...
const Transitions = (): React.JSX.Element => {
  ...
  const { data: ProductData, status: ProductDataStatus } = useGetTransition(
  ...
  return (
    <Fragment>
      ...
      <DataTable
        ...
        columns={TransitionsTableHeader(tableInfo)}
        tableInfo={tableInfo}
